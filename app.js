...
function verificarJugada(idLetra,letraSeleccionada) {  
    if(letraUsada.includes(letraSeleccionada)) {  // verifica si la letra ya fue usada y da un sonido de alerta
        sonidoRepetido()
    }else {
        letraUsada.push(letraSeleccionada); // si no fue usada la letra seleccionada entra a un array
